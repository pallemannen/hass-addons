...
8443, 8123) and relays all traffic straight to your Home Assistant port.
Perfect if you want HA post 2026.8.0 to listen to both port 80 and 8123. 
See [ha_redirect/DOCS.md](ha_redirect/DOCS.md) for configuration,
